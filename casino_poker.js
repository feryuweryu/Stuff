(function(){
	...
	,act = {
		...
		keep1pos:function(){sout('保持第1张卡',1);setTimeout(ce('set1'), 200); setTimeout(ce2(1), 224)},
		keep2pos:function(){sout('保持第2张卡',1);setTimeout(ce('set2'), 242); setTimeout(ce2(2), 123)},
		keep3pos:function(){sout('保持第3张卡',1);setTimeout(ce('set3'), 145); setTimeout(ce2(3), 254)},
		keep4pos:function(){sout('保持第4张卡',1);setTimeout(ce('set4'), 185); setTimeout(ce2(4), 198)},
		keep5pos:function(){sout('保持第5张卡',1);setTimeout(ce('set5'), 198); setTimeout(ce2(5), 154)}
	}
	,ai = {
		keep:function(){
			var ar = read.deck();
